...
export const getFilterdFlightsUrl = (originAirport:string , destinationAirport:string , departureDate:string) =>  FLIGHT_BASE_URL + `filter/${originAirport}/${destinationAirport}/${departureDate}`;
